...
sgMail.setApiKey(
  "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"
);
...
exports.postRegister = (req, res, next) => {
  ...
  User.findOne({ email: email })
    .then((user) => {
      if (user) {
        req.session.errorMessage = "Böyle bir kayıt zaten var.";
        req.session.save(function (err) {
          console.log(err);
    ...
    .then(() => {
      ...
      const msg = {
        ...
        from: "onuryslts@gmail.com", // Change to your verified sender
